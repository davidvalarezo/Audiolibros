...
public class Libro {
    ...
    public String autor;
    //(1) Cargar imágenes de Internet en Audiolibros
    // reemplazar public int recursoImagen; por:
    ...
    public final static String SERVIDOR = "http://mmoviles.upv.es/audiolibros/";
    ...
    //Práctica: Extraer paleta de colores de forma eficiente.
    public int colorVibrante = -1, colorApagado = -1;

    public final static Libro LIBRO_EMPTY =
            new Libro("", "anónimo",
    ...
    public static class LibroBuilder {
        ...
        public LibroBuilder withUrlImagen(String urlImagen) { this.urlImagen = urlImagen; return this; }
        public LibroBuilder withUrlAudio(String urlAudio) { this.urlAudio = urlAudio; return this; }
        public LibroBuilder withGenero(String genero) { this.genero = genero; return this; }
        public LibroBuilder withNuevo(boolean nuevo) { this.nuevo = nuevo; return this; }
        public LibroBuilder withLeido(boolean leido) { this.leido = leido; return this; }
